...
class Unet(nn.Module):
    def __init__(self, in_ch, out_ch, multiple=2):
        ...
        self.conv2 = DoubleConv(32*multiple, 64*multiple, (5, 1), (2, 0))
        self.pool2 = nn.MaxPool2d(2)
        self.conv3 = DoubleConv(64*multiple, 128*multiple, (1, 5), (0, 2))
        # 逆卷积，也可以使用上采样(保证k=stride,stride即上采样倍数)
        self.up8 = nn.ConvTranspose2d(128*multiple, 64*multiple, 2, stride=2)
        self.conv8 = DoubleConv(128*multiple, 64*multiple, (5, 1), (2, 0))
        self.up9 = nn.ConvTranspose2d(64*multiple, 32*multiple, 2, stride=2)
        self.conv9 = DoubleConv(64*multiple, 32*multiple, (1, 5), (0, 2))
